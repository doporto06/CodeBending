...
import json
from csv_processor import CSVProcessor, CSVProcessingError
        ...
        try:
            ...
            if accion == 'crearCurso':
                ...
                if listaClases and allowed_file(listaClases.filename, ALLOWED_EXTENSIONS):
                    ...
                    processor = CSVProcessor(db.session, app.config['UPLOAD_FOLDER'])
                    processor.process(filename, id_curso)
